...
const projects = [
  {
    name: "Real-time Trading Simulator",
    ticker: "RTS",
    tech: "Next.js, Prisma",
    description:
      "A virtual stock market simulator with real-time data and algorithmic trading strategies.",
    link: "https://github.com/ayush/trading-simulator",
  },
  {
  ...
  },
  {
    ...
    ticker: "PT",
    tech: "MongoDB, Chart.js",
    description:
      "Track and visualize portfolio holdings, PnL, and asset allocation in real time.",
    link: "https://github.com/ayush/portfolio-tracker",
  },
];
  ...
  <div className="fixed top-0 right-0 h-full w-[24rem] bg-gray-900 text-white shadow-2xl z-50 transition-all duration-300 ">
    ...
    <div className="flex justify-between items-center p-4 border-b border-gray-700 bg-gray-800">
      <div>
        ...
        <p className="text-sm text-gray-400">
          🏷️ Ticker: <span className="text-blue-300">{selectedProject.ticker}</span>
        </p>
      </div>
    ...
    <div className="p-6 space-y-4">
      ...
      <div className="text-sm">
        ...
        <p className="text-gray-200 leading-snug">{selectedProject.description}</p>
      </div>
      ...
      <div className="text-sm">
        ...
        <p className="text-green-400">Bullish – Strong demand for this skillset</p>
      </div>
    </div>
  </div>
)}
